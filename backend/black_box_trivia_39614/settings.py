"""
Django settings for black_box_trivia_39614 project.
...
ROOT_URLCONF = 'black_box_trivia_39614.urls'
...
WSGI_APPLICATION = 'black_box_trivia_39614.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_box_trivia_39614 API",
    "DESCRIPTION": "API documentation for black_box_trivia_39614 App",
    "VERSION": "v1",
}
